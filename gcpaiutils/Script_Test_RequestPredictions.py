from gcpaiutils.predict.predict import predict_json
import os


PROJECT_ID = 'universal-trail-249303'
MODEL = "ContainerTrainedLogReg"
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = "/gcpaiutils/gcpaiutils/predict/prediction_key_y.json"
...
results = predict_json(PROJECT_ID, MODEL, sample_inference_data)
print(results)
